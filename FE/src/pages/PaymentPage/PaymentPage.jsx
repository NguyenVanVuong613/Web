...
const PaymentPage = () => {
  ...
  const stripe = Stripe('sk_test_51P938JDPH38JqXdRLVkMOg8u4IqzWXfl3EDYwItdtfK18Ov88vEIez2VJNLdRCPVLZ64mboHYvrlKlcCCSxMbLeb00Y5N5vw8w')
  ...
  return (
    <div style={{ background: '#f5f5fa', with: '100%', height: '120vh' }}>
              ...
              <WrapperInfo>
                <div>
                  ...
                  <WrapperRadio onChange={handlePayment} value={payment}>
                    ...
                    <Radio value="stripe">Thanh toan bang stripe</Radio>
                    <Radio value="zalopay">Thanh toan bang zalopay</Radio>
                    <Radio value="momo">Thanh toan bang momo</Radio>
                  </WrapperRadio>
                </div>
              </WrapperInfo>
            </WrapperLeft>
            <WrapperRight>
              ...
              }
              {
                ...
                <ButtonComponent
                  ...
                  size={40}
                  styleButton={{
                    background: `linear-gradient(116deg,  ${['#635bff', '#726bff', '#6a63ff'].join(', ')})`,
                    height: '48px',
                    width: '320px',
                    border: 'none',
                    borderRadius: '4px'
              ...
              }
              {
                ...
                <ButtonComponent
                  ...
                  size={40}
                  styleButton={{
                    background: `linear-gradient(116deg,  ${['#ad006c', '#ad006c', '#ad006c'].join(', ')})`,
                    height: '48px',
                    width: '320px',
                    border: 'none',
                    borderRadius: '4px'
